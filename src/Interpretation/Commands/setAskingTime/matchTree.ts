...
export type       at_shoot =         'at (time)' |   'at (meridiem)' | 'at - a datetime word';
...
// [-> number ] -> timeunit
const INTERVAL = (fork: nodeLike[], deadLeaf?: RegExp, shoot_amount?: shoot, shoot_timeunit?: shoot) => BRANCH([
    node(number, [
    ...
    node(root, [
        ...
        node(ask_ing, [
            ...
            node(question_s, ask_questions_branch = [
                ...
                ...NEXTTIME_datetime([THIS_BRANCH_ITSELF], frb, 'at - a datetime word'),
