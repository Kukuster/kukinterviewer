...
const dummyMatch = async function (this: Command<any>, msg: IIMessage) {
    //msg.text.match('');
...
const dummyPrepare = async function (this: Command<any>, msg: IIMessage, match: RegExpMatchArray) {
    //msg.text;
...
const dummyExecute = async function (this: Command<any>, msg: IIMessage, args: object) {
    //msg.text;
